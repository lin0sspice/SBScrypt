...
unsigned int nStakeMinAge = 60 * 60 * 1;	// minimum age for coin age: 1hour
...
const string strMessageMagic = "Securebit Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if (nHeight == 1)
	{
		nSubsidy = 180000 * COIN;	// 180k coins
...
static const int64 nTargetTimespan = 1 * 60; // 1 blocks
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Securebit
    bool fStrictPayToScriptHash = true; // Always active in Securebit
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Securebit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Securebit";
        CTransaction txNew;
     ...
     printf("block.nNonce = %u \n", block.nNonce);
        ...
        assert(block.hashMerkleRoot == uint256("0x2199cc95c47f6e2b2799463d2418f88fc78dc3c9a09d996218416c05bd8defbe"));
...
unsigned char pchMessageStart[4] = { 0x3c, 0xa6, 0xf7, 0x1b };
